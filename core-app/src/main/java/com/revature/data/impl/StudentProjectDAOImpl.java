...
public class StudentProjectDAOImpl implements StudentProjectDAO {
	...
	public List<StudentProject> getProjectsTakenByStudents() throws DataServiceException {
		List<StudentProject> studentProjects = null;
		try {
			StringBuilder sb = new StringBuilder("SELECT * FROM VW_PROJECT_ACTIVITY_PERCENTAGE_CALCULATION ");
